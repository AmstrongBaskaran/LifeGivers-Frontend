document.addEventListener('DOMContentLoaded', async () => {
    ...
    async function fetchStats() {
        try {
            ...
            verifiedFundraisersEl.textContent = data.verified_fundraisers.toLocaleString();
            pendingFundraisersEl.textContent = data.pending_fundraisers.toLocaleString();
            totalDonationsEl.textContent = '₹' + data.total_donations.toLocaleString('en-IN');
            ...
            stories.forEach(story => {
                ...
                item.innerHTML = `
                    <div style="flex: 1;">
                        ...
                        <p style="margin: 5px 0 0 0; color: #64748b; font-size: 14px; line-height: 1.4;">${story.content.substring(0, 100)}${story.content.length > 100 ? '...' : ''}</p>
                    </div>
